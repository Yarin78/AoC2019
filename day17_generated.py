...
class DecompiledProgram(DecompiledProgramBase):
    ...
    def func0(self):
        ...
        #   36: EQ (571), #0, (571)
        label .lbl_36
        self.mem[571] = 1 if self.mem[571] == 0 else 0
        #   40: ADD (16), #1, (16)
        self.mem[16] += 1
        #   44: EQ (16), #1481, (570)
        self.mem[570] = 1 if self.mem[16] == 1481 else 0
        #   48: JMPF (570), #14
        if not self.mem[570]:
            goto .lbl_14
        #   51: ADD #0, #58, (BP+0)
        ...
        self.mem[573] += 1
        #   87: LT (574), #65, (570)
        self.mem[570] = 1 if self.mem[574] < 65 else 0
        #   91: JMPT (570), #151
        if self.mem[570]:
            goto .lbl_151
        #   94: LT #67, (574), (570)
        self.mem[570] = 1 if 67 < self.mem[574] else 0
        #   98: JMPT (570), #151
        if self.mem[570]:
            goto .lbl_151
        #  101: ADD (574), #-64, (574)
        ...
        self.mem[572] += 1
        #  113: LT (572), #11, (570)
        self.mem[570] = 1 if self.mem[572] < 11 else 0
        #  117: JMPF (570), #165
        if not self.mem[570]:
            goto .lbl_165
        ...
        self.mem[573] += 1
        #  134: EQ (574), #10, (570)
        self.mem[570] = 1 if self.mem[574] == 10 else 0
        #  138: JMPT (570), #189
        if self.mem[570]:
            goto .lbl_189
        #  141: EQ (574), #44, (570)
        self.mem[570] = 1 if self.mem[574] == 44 else 0
        #  145: JMPF (570), #158
        if not self.mem[570]:
            goto .lbl_158
        #  148: JMPF #0, #81
        ...
        #  189: LT (573), #22, (570)
        label .lbl_189
        self.mem[570] = 1 if self.mem[573] < 22 else 0
        #  193: JMPF (570), #165
        if not self.mem[570]:
            goto .lbl_165
        #  196: MUL (572), #1, (1182)
        ...
        #  279: EQ (575), #89, (570)
        self.mem[570] = 1 if self.mem[575] == 89 else 0
        #  283: EQ (575), #121, (575)
        self.mem[575] = 1 if self.mem[575] == 121 else 0
        #  287: ADD (575), (570), (575)
    ...
    def func579(self, p0=0, p1=0, p2=0):
        ...
        label .lbl_597
        self.mem[570] = 1 if p1 == p2 else 0
        #  601: JMPT (570), #617
        if self.mem[570]:
            goto .lbl_617
    ...
    def func622(self, p0=0, p1=0, p2=0, p3=0):
        ...
        #  655: EQ (BP+-1), #-4, (570)
        self.mem[570] = 1 if p3 == -4 else 0
        #  659: JMPT (570), #709
        if self.mem[570]:
            goto .lbl_709
        #  662: EQ (BP+-1), #-5, (570)
        self.mem[570] = 1 if p3 == -5 else 0
        #  666: JMPT (570), #734
        if self.mem[570]:
            goto .lbl_734
        #  669: LT (BP+-1), #0, (570)
        self.mem[570] = 1 if p3 < 0 else 0
        #  673: JMPT (570), #759
        if self.mem[570]:
            goto .lbl_759
        #  676: JMPF (BP+-1), #774
        ...
        self.mem[578] += 1
        #  713: EQ (578), #4, (570)
        self.mem[570] = 1 if self.mem[578] == 4 else 0
        #  717: JMPF (570), #724
        if not self.mem[570]:
            goto .lbl_724
        #  720: ADD (578), #-4, (578)
        ...
        self.mem[578] -= 1
        #  738: EQ (578), #-1, (570)
        self.mem[570] = 1 if self.mem[578] == -1 else 0
        #  742: JMPF (570), #749
        if not self.mem[570]:
            goto .lbl_749
        #  745: ADD (578), #4, (578)
    ...
    def func786(self, p0=0, p1=0, p2=0, p3=0, p4=0, p5=0):
        ...
        label .lbl_814
        p4 = 1 if p0 == self.mem[576] else 0
        #  818: EQ (BP+-5), (577), (570)
        self.mem[570] = 1 if p1 == self.mem[577] else 0
        ...
        self.mem[878] = p3
        #  877: EQ (0), #1, (570)
        self.mem[570] = 1 if self.mem[self.mem[878]] == 1 else 0
        #  881: JMPF (570), #916
        if not self.mem[570]:
            goto .lbl_916
        #  884: ADD (374), #1, (374)
        ...
        p0 += 1
        #  933: EQ (BP+-6), #37, (570)
        self.mem[570] = 1 if p0 == 37 else 0
        #  937: JMPF (570), #814
        if not self.mem[570]:
            goto .lbl_814
        #  940: OUT #10
        ...
        p1 += 1
        #  946: EQ (BP+-5), #43, (570)
        self.mem[570] = 1 if p1 == 43 else 0
        #  950: JMPF (570), #810
        if not self.mem[570]:
            goto .lbl_810
        #  953: OUT #10
    ...
    def func979(self, p0=0, p1=0, p2=0, p3=0, p4=0):
        ...
        p2 += 1
        #  995: EQ (BP+-2), #82, (BP+-1)
        p4 = 1 if p3 == 82 else 0
        #  999: JMPT (BP+-1), #1030
        if p4:
            goto .lbl_1030
        # 1002: EQ (BP+-2), #76, (BP+-1)
        p4 = 1 if p3 == 76 else 0
        # 1006: JMPT (BP+-1), #1037
        if p4:
            goto .lbl_1037
        # 1009: LT (BP+-2), #48, (BP+-1)
        p4 = 1 if p3 < 48 else 0
        # 1013: JMPT (BP+-1), #1124
        if p4:
            goto .lbl_1124
        # 1016: LT #57, (BP+-2), (BP+-1)
        p4 = 1 if 57 < p3 else 0
        # 1020: JMPT (BP+-1), #1124
        if p4:
            goto .lbl_1124
        ...
        label .lbl_1107
        p4 = 1 if p3 == 10 else 0
        # 1111: JMPT (BP+-1), #1162
        if p4:
            goto .lbl_1162
        # 1114: EQ (BP+-2), #44, (BP+-1)
        p4 = 1 if p3 == 44 else 0
        # 1118: JMPF (BP+-1), #1131
        if not p4:
            goto .lbl_1131
        # 1121: JMPT #1, #989
